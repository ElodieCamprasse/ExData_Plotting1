...
par(mfrow = c(2, 2))
plot(new_data_OK$Date_time, as.numeric(type.convert(as.character(new_data_OK$V3), dec = ".")), type= 'l', font.axis=1, main = " ", xlab= " ", ylab="Global Active Power")
plot(new_data_OK$Date_time, as.numeric(type.convert(as.character(new_data_OK$V5), dec = ".")), type= 'l', font.axis=1, main = " ", xlab= "datetime", ylab="Voltage")
...
plot(new_data_OK$Date_time, as.numeric(type.convert(as.character(new_data_OK$V4), dec = ".")), type= 'l', font.axis=1, cex.axis=0.8, main = " ", xlab= "datetime", ylab="Global_reactive_power")
dev.copy(png, file = "plot4.png")
dev.off()